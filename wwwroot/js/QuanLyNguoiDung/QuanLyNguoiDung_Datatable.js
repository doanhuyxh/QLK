$(document).ready(function () {
    ...
    $("#tblQuanLyNguoiDung").DataTable({
        ...
        "ajax": {
            "url": "/QuanLyNguoiDung/GetDataTabelData",
            "type": "POST",
            "datatype": "json"
        },
        ...
        "columns": [
            ...
            { "data": "HoVaTen", "name": "HoVaTen" },
            {
                ...
                render: function (data, type, row) {
                    return "<img style='width:100px;height:100px;object-fit: cover;' src='" + row.AnhDaiDienPath + "'/>";
                },
            },
            { "data": "SoDienThoai", "name": "SoDienThoai" },
            { "data": "TaiKhoan", "name": "TaiKhoan" },
            { "data": "QuanLyNhomNguoiDungDisplay", "name": "QuanLyNhomNguoiDungDisplay" },
            {
                "data": "NgayThem",
                "name": "NgayThem",
                "autoWidth": true,
