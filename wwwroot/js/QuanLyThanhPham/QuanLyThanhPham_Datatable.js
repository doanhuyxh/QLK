$(document).ready(function () {
    document.title = 'Quản lý thành phẩm';

    $("#tblQuanLyThanhPham").DataTable({
        paging: true,
        select: true,
        "order": [[0, "desc"]],
        dom: 'Bfrtip',
        ...
        "ajax": {
            "url": "/QuanLyThanhPham/GetDataTabelData",
            "type": "POST",
            "datatype": "json"
        },
        ...
        "columns": [
            ...
            { "data": "TenThanhPham", "name": "TenThanhPham" },
            ...
            { "data": "PO", "name": "PO" },
            {
                data: null, render: function (data, type, row) {
                    return "<a href='#' class='btn btn-primary m-auto' onclick=AddEdit('" + row.Id + "');>Sửa</a>";
                }
            },
            {
                data: null, render: function (data, type, row) {
                    return "<a href='#' class='btn btn-danger m-auto' onclick=Delete('" + row.Id + "'); >Xóa</a>";
                }
            }
        ],
