$(document).ready(function () {
    document.title = 'Theo dõi chất lượng';

    $("#tblTheoDoiChatLuong").DataTable({
        paging: true,
        select: true,
        "order": [[0, "desc"]],
        dom: 'Bfrtip',
        ...
        "ajax": {
            "url": "/TheoDoiChatLuong/GetDataTabelData",
            "type": "POST",
            "datatype": "json"
        },
                ...
                "render": function (data, type, row) {
                    ...
                    switch (data) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            chatLuong = "Không Đạt";
                            break;
                        default:
                            chatLuong = "Không xác định";
                            break;
                    }
                    return chatLuong;
                }
            },
            { "data": "GhiChuVeChatLuong", "name": "GhiChuVeChatLuong" },
            {
                "data": "CreatedDate",
                "name": "CreatedDate",
                "autoWidth": true,
