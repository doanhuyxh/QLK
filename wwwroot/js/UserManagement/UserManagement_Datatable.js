        ...
        "columns": [
            { "data": "UserProfileId", "name": "UserProfileId" },
            {
                data: null, render: function (data, type, row) {
                    ...
                    return "<div class='image'><img src='" + row.ProfilePicturePath + "' class='img-circle elevation-2' alt='Ảnh đại diện'></div>";
                }
            },
            {
            ...
            { "data": "GroupUserDisplay", "name": "GroupUserDisplay", "autoWidth": true },
            {
                "data": "CreatedDate",
                "name": "CreatedDate",
                "autoWidth": true,
