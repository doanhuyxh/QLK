$(document).ready(function () {
    document.title = 'Xây dựng công thức';

    $("#tblThanhPham").DataTable({
        paging: true,
        select: true,
        "order": [[0, "desc"]],
        dom: 'Bfrtip',
        ...
        "ajax": {
            "url": "/XayDungCongThuc/GetDataTabelData",
            "type": "POST",
            "datatype": "json"
        },
        ...
        "columns": [
            ...
            { "data": "Description", "name": "Description" },
            {
                data: null, render: function (data, type, row) {
                    return "<a href='#' class='btn btn-primary' onclick=AddEdit('" + row.Id + "');>Chỉnh sửa</a>";
                }
            },
            {
                data: null, render: function (data, type, row) {
