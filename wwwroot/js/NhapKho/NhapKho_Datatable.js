        ...
        "columns": [
            ...
            { "data": "MoTa", "name": "MoTa" },
            {
                data: null, render: function (data, type, row) {
                    return "<a href='#' class='btn btn-primary'  style='margin:auto' onclick=AddEdit('" + row.Id + "');>Thông tin đã nhập</a>";
                }
            },
            {
                data: null, render: function (data, type, row) {
            ...
            {
                data: null, render: function (data, type, row) {
                    return "<a href='#' class='btn btn-danger' style='margin:auto' onclick=Delete('" + row.Id + "'); >Xóa</a>";
                }
            }
        ],
